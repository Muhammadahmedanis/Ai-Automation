...
const ContactCard = ({ contact, selected, toggleSelect }) => {
  ...
  return (
    <div
      className={`flex items-center p-2 md:p-4 rounded-lg border border-gray-200 transition-colors ${
        isSelected ? "bg-[#e4fff5]" : "hover:bg-[#f5fffb]"
      }`}
    >
      ...
      <img
        src="/Boy.png"
        alt="Profile"
        className="md:w-5 md:h-5 w-6 h-6 rounded-full mr-4"
      />
      ...
      <div className="flex justify-between items-center mb-4 flex-col md:flex-row gap-4">
        ...
        <div className="flex items-center space-x-2 md:space-x-4 text-xs flex-wrap gap-2">
              ...
              <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl mx-4 animate-fade-in-up transition-all duration-300">
                <div className="flex items-center bg-[#aeead2]  justify-between p-5 border-b border-gray-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      AI has found 23 contact from website visitors Select the
                      contacts you want to add to your campaign or CRM.
                    </p>
                  </div>
                  <button
                    onClick={() => setIsModal2(false)}
                ...
                <div className="flex justify-end gap-2 p-4">
                  <button
                    ...
                    className="py-2 px-5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-full hover:bg-gray-100 cursor-pointer"
                  >
                    Add to campaign
                  </button>
                  <button className="py-2 px-5 text-sm font-medium text-white bg-[#16C47F] hover:bg-[#FF9D23] rounded-full cursor-pointer">
                    Add to CRM
                  </button>
                </div>
              </div>
          ...
          <button
            ...
            className="px-3 flex items-center gap-1 cursor-pointer text-[13px] md:px-6 py-1.5 md:py-3 rounded-full text-white bg-[#16C47F] hover:bg-[#FF9D23]"
          >
            Add to campaign
          ...
          {isModal && (
            ...
            >
              <div
                ...
                className="bg-white rounded-xl shadow-lg w-full max-w-md mx-4 animate-fade-in-up transition-all duration-300"
              >
                ...
                <div className="p-5 space-y-3">
                  ...
                  <p className="text-sm text-gray-500">
                    Choose the campaign you want to send the notification from.
                  </p>
                ...
                <div className="flex justify-end gap-2 p-4">
                  <button
                    onClick={() => setIsModal(false)}
                    className="py-2.5 px-5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-full hover:bg-gray-100 hover:text-blue-700 cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button className="py-2.5 px-5 text-sm font-medium text-white bbg-[#16C47F] hover:bg-[#FF9D23] rounded-full cursor-pointer">
                    Add to campaign
                  </button>
                </div>
              </div>
